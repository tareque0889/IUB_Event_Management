...
/**
 * Resolves the initial theme. The no-flash script in index.html has already
 * added the `.dark` class before paint, so prefer that; fall back to stored
 * preference / OS setting when the component mounts on its own.
 */
...
export function ThemeToggle({
  ...
  useEffect(() => {
    ...
    if (meta) meta.setAttribute("content", dark ? "#1E1333" : "#ffffff");
  }, [dark]);
